...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(Maze))==(x_axis_range_of_maze,y_axis_range_of_maze,maze_area,internal_walls_of_maze,free_square_of_maze,initial_square_of_maze,exit_square_of_maze);
  Inherited_List_Constants(Machine(Maze))==(?);
  List_Constants(Machine(Maze))==(x_axis_range_of_maze,y_axis_range_of_maze,maze_area,internal_walls_of_maze,free_square_of_maze,initial_square_of_maze,exit_square_of_maze)
END
&
THEORY ListSetsX IS
...
THEORY ConstantsEnvX IS
  Constants(Machine(Maze)) == (Type(x_axis_range_of_maze) == Cst(SetOf(btype(INTEGER,"[x_axis_range_of_maze","]x_axis_range_of_maze")));Type(y_axis_range_of_maze) == Cst(SetOf(btype(INTEGER,"[y_axis_range_of_maze","]y_axis_range_of_maze")));Type(maze_area) == Cst(SetOf(btype(INTEGER,?,?)*btype(INTEGER,?,?)));Type(internal_walls_of_maze) == Cst(SetOf(btype(INTEGER,?,?)*btype(INTEGER,?,?)));Type(free_square_of_maze) == Cst(SetOf(btype(INTEGER,?,?)*btype(INTEGER,?,?)));Type(initial_square_of_maze) == Cst(btype(INTEGER,?,?)*btype(INTEGER,?,?));Type(exit_square_of_maze) == Cst(btype(INTEGER,?,?)*btype(INTEGER,?,?)))
END
&
THEORY TCIntRdX IS
  predB0 == OK;
